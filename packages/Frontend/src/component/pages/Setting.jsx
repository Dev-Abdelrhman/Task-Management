...
//                     <h3 className="text-lg font-medium text-gray-800 dark:text-gray-400 mb-2">Notification Settings</h3>
//                     <p className="text-sm text-gray-600 dark:text-[#a0a0a0]">Configure your notification preferences here.</p>
//                 </div>
//             )}
//         </div>
//     );
