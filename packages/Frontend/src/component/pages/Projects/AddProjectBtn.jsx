                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 mt-6">
                            <div className="flex flex-col justify-center items-center mb-4">
                                {newProject.image ? (
                                    <img src={newProject.image ? URL.createObjectURL(newProject.image) : ""} alt="" className="mb-3 rounded-4 w-[160px] h-[160px]" />

                                ) : ('')}
                                <label
                                    htmlFor="projectImage"
                                    className="flex gap-2 p-2 justify-center cursor-pointer border border-dashed border-gray-400 px-4 py-3 rounded-[10px] bg-[#f8f8f8]  mb-1 text-border font-medium text-gray-700"
                                >
                                    Upload image
                                    <Upload />
                                </label>
