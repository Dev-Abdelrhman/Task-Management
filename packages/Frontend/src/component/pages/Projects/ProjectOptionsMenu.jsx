                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                        <div className="bg-white p-8 rounded-xl max-w-[600px] relative">
                            ...
                            <p className="text-gray-600 mb-6 text-center">
                                All users will lose access to project <span className="font-medium">{projectData.name}</span> and all backup snapshots for this project will be removed.
                            </p>
                            ...
                            <div className="mb-6">
                                <p className="text-sm text-gray-600 mb-2">Type "{projectData.name}" to confirm your action</p>
                                <input
                                    type="text"
