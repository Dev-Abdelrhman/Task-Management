      ...
      <div className="px-4 pb-4 pt-3 bg-gray-100 min-h-screen ">
        {taskDetailsModal.show && (
          <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-end">
            <div className="bg-white w-[480px] rounded-[10px] h-screen shadow-lg px-6 overflow-y-auto">
              ...
              <div className="flex justify-end gap-2 mt-6">
                ...
                <Button
                  onClick={() => {
                    ...
                    setDeleteModal({
                      show: true,
                      taskId: taskDetailsModal.task._id,
                    });
                  }}
        ...
        {showModal && (
          <AddTask
            ...
            initialStatus={
              selectedColumn ? statusMap[selectedColumn] : "Pending"
            }
