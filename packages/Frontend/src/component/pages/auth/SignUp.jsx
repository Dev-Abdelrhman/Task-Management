      ...
      <div className="flex h-screen w-full">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-6 bg-gray-50">
          <Card className="w-full max-w-md border-0 !shadow-xl">
            <h2 className="text-3xl font-bold text-center text-blue-700 pt-6">Sign-up</h2>
            ...
            <CardContent className="space-y-4">
              ...
              <Button type="submit" variant="contained" borderRadius="40px" className="!bg-blue-600 text-white w-full !py-3 !rounded-xl">Sign Up</Button>
