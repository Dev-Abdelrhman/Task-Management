    ...
    <div className="flex">
      ...
      {isEditMode && (
        <div >
            ...
            <AddProjectBtn isEditMode={true} projectToEdit={projectData}  setShowModal={() => setIsEditMode(false)}
            />
        </div>
      )
      }
        ...
        <div className="!fixed !inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded-xl w-full max-w-md">
            <div className="text-center mb-4">
              <h3 className="text-lg font-semibold text-gray-900">Are you sure you want to delete this project?</h3>
            </div>
